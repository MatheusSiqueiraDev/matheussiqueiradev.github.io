                ...
                <div class='d-flex flex-wrap flex-sm-nowrap justify-content-center justify-content-sm-between'>
                    ...
                    <div class='d-flex justify-content-center align-items-center flex-column'>
                        <div style='width: 75px; height: 60px' class='indicacao indicacao-${element.classificacao} p-2'>
                            <h2>
                                ${
                                    element.classificacao == 0 ? 'LIVRE' : element.classificacao
                                }
                            </h2>
                            
                        </div>
                        <div>
                            <span class='fa fa-star ${Math.abs(start) >= 1 ? 'checked' : ''}'></span>
                            <span class='fa fa-star ${Math.abs(start) >= 2 ? 'checked' : ''}'></span>
                            <span class='fa fa-star ${Math.abs(start) >= 3 ? 'checked' : ''}'></span>
                            <span class='fa fa-star ${Math.abs(start) >= 4 ? 'checked' : ''}'span>
                            <span class='fa fa-star ${Math.abs(start) >= 5 ? 'checked' : ''}'></span>
                        </div>
                    </div>
                </div>
                <div class='px-2'>
